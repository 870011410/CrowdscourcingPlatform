...
<div class="my-content">
	...
	<div >
		<h1 class="my-head-text">选择需求的类型，进行发布</h1>
	</div>
...
<!--按钮位置  -->
	...
	<script>
		...
		function chooseNeedType(item){
			...
			//选中的需求类型id
			var needtypeId=$(item).attr("needId");
			//选中的需求类型
			var needTypeName = $(item).attr("needName");
			//带着需求类型信息跳转到添加需求界面
			
			$.ajax({
				url: "jumpAddNeedWithNeedType.action",
				type: "post",
				data: {
