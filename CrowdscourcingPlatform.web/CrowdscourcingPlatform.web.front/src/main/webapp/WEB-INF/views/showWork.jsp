			...
			<div class="sc-box">
				<div class="sc-row search__box">
					<div class="search__item">
						<div class="item__left"><span class="sc-row-title search__title">服务类型：</span></div>
						<div class="item__right">
							<div class="sc-row-options search__btn search__btn--mb" id="service_box"><span class="option btn__item active" onclick="chooseServ(this)">
                                                    不限
                                                </span></div>
						</div>
					</div>
					<div class="search__item search__item--bottom">
						<div class="item__left"><span class="sc-row-title search__title">作品类型：</span></div>
						<div class="item__right">
							<div class="sc-row-options search__btn" id="type_box"><span class="option btn__item active">
                                                    不限
                                                </span></div>
						</div>
					</div>
					...
					$.ajax({
						...
						success: function(msg) {
							...
							for (var i = 0; i < works.length; i++) {
								...
								+"workId="+work.id
								+" onclick='workDeti(this)'>立即购买</button>"
								+"</div>"
								+"</div>"
                                +"</div>"
						        +"</div>");
							...
							if(count!=0){
							$("#project-list").append("<div id='page' align='center' class='page'></div>");
							}
							//页码的处理
