		...
		<div class="div-logArea">
			...
			<div class="layui-form my-form" id="main-box" action="">
                ...
                <div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input id="in-type" lay-verify="required" class="layui-input" readonly="readonly">
					</div>
				</div>
                <div class="layui-form-item">
			...
			function inputDataHandle(data) {
				...
				$.ajax({
					...
					success: function(msg) {
						...
						$("#in-user").val(tender.userName);
						$("#in-type").val(tender.typeName);
						$("#in-myself").append(tender.memo);
