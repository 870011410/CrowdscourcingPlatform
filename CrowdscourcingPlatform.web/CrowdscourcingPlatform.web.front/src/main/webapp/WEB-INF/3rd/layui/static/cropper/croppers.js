...
layui.config({
    ...
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\"3rd/layui/static/cropper/cropper.css\">\n" +
        ...
        "        </div>\n" +
        "        <div class=\"layui-form-mid layui-word-aux\">头像的尺寸限定100x100px</div>\n" +
        "    </div>\n" +
            ...
            $(".layui-btn").on('click',function () {
                ...
                if(event == 'confirmSave'){
                    ...
                    image.cropper("getCroppedCanvas",{
						...
						var myDate = new Date();
						//把图片名拼接上时间
						var fileName = myDate.getTime()+path.substring(pos + 1);
